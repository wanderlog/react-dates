...
var DayPickerSingleDateController = exports["default"] = /*#__PURE__*/function (_ref2, _ref) {
  ...
  _proto.isBlocked = function isBlocked(day) {
    var _this$props0 = this.props,
      isDayBlocked = _this$props0.isDayBlocked,
      isOutsideRange = _this$props0.isOutsideRange;
  ...
  _proto.render = function render() {
    var _this$props1 = this.props,
      ...
      dayPickerNavigationInlineStyles = _this$props1.dayPickerNavigationInlineStyles,
      navPosition = _this$props1.navPosition,
      navPrev = _this$props1.navPrev,
      navNext = _this$props1.navNext,
      renderNavPrevButton = _this$props1.renderNavPrevButton,
      renderNavNextButton = _this$props1.renderNavNextButton,
      noNavButtons = _this$props1.noNavButtons,
      noNavPrevButton = _this$props1.noNavPrevButton,
      noNavNextButton = _this$props1.noNavNextButton,
      onOutsideClick = _this$props1.onOutsideClick,
      onShiftTab = _this$props1.onShiftTab,
      onTab = _this$props1.onTab,
      withPortal = _this$props1.withPortal,
      focused = _this$props1.focused,
      ...
      showKeyboardShortcuts = _this$props1.showKeyboardShortcuts,
      weekDayFormat = _this$props1.weekDayFormat,
